...
The payload of `trcks.Failure` values is a frozen Error dataclass from
   [`subscription_management.data_structures.domain.errors`](subscription_management/data_structures/domain/errors.py).
